...
function changeCSS(cssfile) {
    ...
    document.cookie = "color=" + cssfile + "; expires=" + new Date(2030, 1).toUTCString();
}

function setCookie(percent) {
    document.cookie = "fontSize=" + percent + "; expires=" + new Date(2030, 1).toUTCString();
}
