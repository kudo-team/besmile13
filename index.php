...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/60a278c31f.css">
    <!--レスポンシブコーディング-->
...
<header>
    <h1>
        <img src="images/besmile_logo.png" alt="BeSmile（ビースマイル）">
        大阪のA型事業所<br>
        BeSmile十三駅前
    </h1>
...
<main>
    <section class="Cherry__Menu">
        <nav id="hanabira">
            <div class="img_fit_div">
                <img src="images/wood.png" id="main_image" alt="桜" loading="lazy">
    ...
    <section>
        <p style="text-align:center;font-size:2em;"><a href="bbq.pdf" target="_blank" rel="noopener">令和二年度地域連携報告</a></p>
    </section>
    ...
    <section class="Section__Odd" id="section01">
        ...
        <div class="Section__Odd__Contents">
            <figure>
                <img src="images/a_news.png" alt="ニュースを読むうさぎ" loading="lazy">
                <figcaption>※BeSmile（ビースマイル）イラストチーム制作</figcaption>
            </figure>
            <div class="Section__Odd__Paragraph">
                <p>就労継続支援A型とは、主に心身に障害をお持ちの方に対して、将来的な一般就労を目標とした自立を支援するために就労の場を提供する福祉サービスのことです。<br>
        ...
        <div class="Section__Odd--cherry">
            <img src="images/sakura_1.png" alt="" loading="lazy">
        </div>
    </section>
    <!--/A型事業所とは-->
    ...
    <section class="Section__Even" id="section02">
        ...
        <div class="Section__Even__Content">
            ...
            <figure>
                <img src="images/sound.png" alt="指揮棒を振るうさぎ" loading="lazy">
                <figcaption>※BeSmile（ビースマイル）イラストチーム制作</figcaption>
            </figure>
        </div>
        <div class="Section__Even--cherry">
            <img src="images/sakura_2.png" alt="" loading="lazy">
        </div>
    ...
    <section class="Section__Odd" id="section03">
        ...
        <div class="Section__Odd__Contents">
            <figure>
                <img src="images/pc.png" alt="ホームページを作るうさぎ" loading="lazy">
                <figcaption>※BeSmile（ビースマイル）イラストチーム制作</figcaption>
            </figure>
            <div class="Section__Odd__Paragraph">
        ...
        <div class="Section__Odd--cherry">
            <img src="images/sakura_1.png" alt="桜の枝の装飾" loading="lazy">
        </div>
    </section>
    <!--/ホームページ制作-->
    <!--イラスト-->
    <section class="Section__Even" id="section04">
        ...
        <div class="Section__Even__Content">
            ...
            <figure>
                <img src="images/illust.png" alt="イラストを書くうさぎ" loading="lazy">
                <figcaption>※BeSmile（ビースマイル）十三駅前イラストチーム制作</figcaption>
            </figure>
        </div>
        <div class="Section__Even--cherry">
            <img src="images/sakura_2.png" alt="桜の枝の装飾" loading="lazy">
        </div>
    </section>
    ...
    <section class="Section__Odd" id="section05">
        ...
        <div class="Section__Odd__Contents">
            <figure>
                <img class="pc_2" src="images/pirograming.png" alt="プログラミングをしているうさぎ" loading="lazy">
    ...
    <section class="Section__Even" id="section06">
        ...
        <div class="Section__Even__Content">
            ...
            <figure>
                <img src="images/guiter.png" alt="ギターを引くうさぎ" loading="lazy">
