    ...
    <nav class="Hamburger__Menu" id="Hamburger__Menu">
        ...
        <div class="Hamburger__Menu__Content">
            <ul>
                ...
                <li class="only_mobile"><a href="<?php echo esc_url(home_url('/web_portfolio/')); ?>">WEBチームポートフォリオ</a></li>
                <li class="only_mobile"><a href="https://shop.bsma.team/">BSMA! CREATORS SHOP</a></li>
